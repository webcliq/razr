...
class Lexer
{
    ...
    protected function lexData()
    {
        ...
        if (preg_match(self::REGEX_START, $this->code, $match, strlen((string)null), $this->cursor)) {
            if (isset($match[1])) {
    ...
    {
        if (preg_match(self::REGEX_STRING, $this->code, $match, strlen((string)null), $this->cursor)) {
